...
// DeepSeek v3 模型实现
class DeepseekV3Model : public ModelInterface {
public:
    DeepseekV3Model();
    ~DeepseekV3Model() override;
...
private:
    ...
    // 支持的模型列表
    static constexpr const char* MODEL_ID = "deepseek-v3";
    static constexpr const char* MODEL_NAME = "DeepSeek Chat v3";
